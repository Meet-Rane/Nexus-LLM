...
public class CreateFileRequest {
    ...
    public static CreateFileRequest fromString(String raw) {
        if (raw == null || raw.isBlank()) {
            return new CreateFileRequest("file.txt", "");
        }
        ...
        if (trimmed.startsWith("{")) {
            try {
                ...
                if (c != null && !c.isBlank()) {
                    return new CreateFileRequest(p != null ? p : "file.txt", c);
                }
            ...
            if (m.find()) {
                ...
                return new CreateFileRequest(path != null ? path : "file.txt", extractedContent);
            }
        }
        return new CreateFileRequest("file.txt", raw);
    }
